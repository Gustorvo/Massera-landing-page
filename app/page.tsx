      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          >
            {isInView ? (
              <iframe
                src="https://player.mux.com/FZYIfZ00qT8ITic52Gnl02Hn14QckE4EdpFgxOdWgXhPw?metadata-video-title=Video&accent-color=%23455768&poster=https://image.mux.com/FZYIfZ00qT8ITic52Gnl02Hn14QckE4EdpFgxOdWgXhPw/thumbnail.png?time=49&fit_mode=preserve"
